...
class SptPy(
    ...
    CSS = (
        ...
        "#grid { layout: grid; grid-size: 2 5; grid-gutter: 0 0; "
        "grid-columns: 38 1fr; grid-rows: auto auto 1fr auto auto; height: 1fr; margin: 0; padding: 0; }\n"
        ...
        "#top_spacer { column-span: 2; height: 1; margin: 0; padding: 0; }\n"
        "#grid_spacer { column-span: 2; height: 1; margin: 0; padding: 0; }\n"
